...
$sql = "UPDATE startup_support
       SET id = :id, 受講者番号 = :受講者番号 , 名前 = :名前 , 生年月日 = :生年月日, 作成日=:作成日,
        経営（福岡県VB支援）=  :経営（福岡県VB支援）, 経営（福岡商工）=:経営（福岡商工）, 経営（政策金融）=:経営（政策金融）, 経営（福岡市）=:経営（福岡市）,
       財務（福岡県VB支援）=:財務（福岡県VB支援）, 財務（福岡商工）=:財務（福岡商工）,財務（政策金融）=:財務（政策金融）, 財務（福岡市）=:財務（福岡市）,
       販路（福岡県VB支援）=:販路（福岡県VB支援）, 販路（福岡商工）=:販路（福岡商工）,販路（政策金融）=:販路（政策金融）, 販路（福岡市）=:販路（福岡市）,
       人材育成（福岡県VB支援）=:人材育成（福岡県VB支援）, 人材育成（福岡商工）=:人材育成（福岡商工）,人材育成（政策金融）=:人材育成（政策金融）, 人材育成（福岡市）=:人材育成（福岡市）,
       完了確認日 =:完了確認日        WHERE id=:id";
